...
export default function ViewAllItems() {
  ...
  async function handleRequestSubmissison(event){
    ...
    try {
      await updateDoc(doc(db, "Allrequests", "requests"), {
        request: arrayUnion({
                ...
                <div class="card" style={{ width: "18rem" }}>
                  ...
                  <div class="card-body">
                    ...
                    <div className="d-flex justify-content-around">
                      ...
                      >
                        <>
                        {!requestStatus ? (<div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              >
                                <IoGitPullRequest/> Item Selected: {item.title} 
                              </h1>
                              <button
                                type="button"
                                class="btn-close"
                        ...
                        <span className="m-1">Request Send Successfully </span><FaCheckCircle size={30}/>
                        <div className="m-1">
